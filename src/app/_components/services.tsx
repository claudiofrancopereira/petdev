        ...
        <section className='bg-white py-16'>
            <div className='container mx-auto px-4'>
                ...
                <div className='relative'>
                                ...
                                <div key={index} className='flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3'>
                                    <article className='bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col'>
                                        ...
                                        <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                                            ...
                                            <a
                                                target='_blank'
                                                href={`https://wa.me/5517999999?text=Olá! Vim pelo site e gostaria de mais informação sobre ${item.title}`}
                    ...
                    <button
                        className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute left-3 -translate-y-1/2 -translate-1/2 top-1/2 z-10'
                        onClick={scrollPrev}
                    >
                    ...
                    <button
                        className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-7 -translate-y-1/2 -translate-1/2 top-1/2 z-10'
                        onClick={scrollNext}
                    >
